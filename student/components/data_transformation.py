...
from student.utils.main_utils import read_yaml_file, save_object, save_numpy_array_data, load_data
...
class DataTransformation:
    ...
    def _remove_outliers_IQR(self, col, df):
        ...
        try:
            ...
            # Explicitly casting to the column's dtype
            upper_limit = upper_limit.astype(df[col].dtype)
            lower_limit = lower_limit.astype(df[col].dtype)
